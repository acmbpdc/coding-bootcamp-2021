...
```
As you can see in the example above, 3 is greater than 0. The condition was true and the block code was executed. However, the  else  keyword catches anything which isn't caught by the preceding conditions.
...
The condition above proves false, therefore the else block was executed. If we have more than 2 conditions to check, We could use _ elif_.
### If Elif Else
...
- __Complex Numbers Example__ : `1 + j, 2 + 4j, 1 - 1j`
